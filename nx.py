...
kr = KRIS.LINE()
#kr.login(qr=True)
kr.login(token='EophSllDwoSDOxMCLFP5.wZv3dNppRTb4m8nv9NbB1q.F4MWZ1ZRK9IT7S+dtZ6Bdcat27D2+p9/9CMQ7ihWwTg=')#r
kr.loginResult()

ks = KRIS.LINE() #Assist
ks.login(token='EoxD70BeiWVqRLqpyPX2.VyJ6iKnWDMTkM+Do0igvSG.hJ++MWKyj/dNZX5ol/wvRgBTG2sY7N8vd1wIyLKSxIE=')
ks.loginResult()
...
helpmsg ="""
╔═════════════
║ ᴰᵀᴮ丂̶̶̴̶̶̴̶̶̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́ᴇ̶̶̴̶̶̴̶̶̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́ʟ̶̶̴̶̶̴̶̶̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́ғ̶̶̴̶̶̴̶̶̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́ʙ̶̶̴̶̶̴̶̶̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́ᴏ̶̶̴̶̶̴̶̶̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́ᴛ̶̶̴̈́͊̈́̈́͊̈́̈́͊̈́
╠═════════════
║[❂]google (text)
║[❂]playstore (text)
║[❂]instagram (username)
...
Bots=[mid,Amid]
admin=["u5b35770e73cfaed07833c355f6705bd5","ubd88fa224370766b4a9bf74ed08195b2",mid]
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["Kenapa Tag?, Kalo Penting PC Aja","Ada Apa?","Kenapa sih tag? Penting? Miscall aja","NyX Lagi Main ML","NyX Lagi Ngedit Script","NyX sibuk nih","NyX Lagi Main Game","Da pa?"]
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                if wait["autoCancel"]["on"] == True:md+="╠[❂]Auto cancel -> " + str(wait["autoCancel"]["members"]) + "on\n"
                ...
                ks.sendMessage(msg)
                ks.sendText(msg.to,'Itu adalah creator bodoh saya 😂  􀜁􀄯􏿿')
...
#==============================================================================#
              ...
              if msg.from_ in owner:
                ...
                ks.kickoutFromGroup(msg.to,[midd])
                    ...
                    key = msg.text[-33:]
                    ks.findAndAddContactsByMid(key)
                    ks.inviteIntoGroup(msg.to, [key])
                    contact = ks.getContact(key)
...
#==============================================================================#
            ...
            elif msg.text in ["Bot1 Glist","bot1 Glist","Bot1 glist","bot1 glist"]:
                gid = ks.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "%s\n" % (ks.getGroup(i).name +" ? ["+str(len(ks.getGroup(i).members))+"]")
                ks.sendText(msg.to,"-- List Groups --\n\n"+ h +"\nTotal groups =" +" ["+str(len(gid))+"]")
...
#=================================KRIS SCRIPT FINISHED =============================================#
            ...
            elif msg.text in ["Clear","clear","Clear ban","Clear Ban"]:
                wait["blacklist"] = {}
