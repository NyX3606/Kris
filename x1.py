...
import THB
from THB.lib.curve.ttypes import *
...
kr = THB.LINE() #selfbot
#kr.login(qr=True)
kr.login(token='Eokja2qI6HWGaZUYBxS8.50Tq9a0wY9VHRwoQVQeZ2a.1+My+1ZbCZpxLMVvW4oQpV/cPrI6rVoB7mHz5ycEIkA=')#r
kr.loginResult()

ks = THB.LINE() #assist1
ks.login(token='EoVTkUu0t25aSwItif7b.vFdDEUf8mVc3P9OVQhnXwW.GyidDe9HuXfv8mEmhLomSJWzwtvePwLKJN5IKd20jMU=')
ks.loginResult()

ks1 = THB.LINE() #assist2
ks1.login(token='Eoy0RKliuGy7ZyTNewF6.CPqR2dKXkmhKWpXlkDNz9G.aIzINH2+C5m6mZUKAdiVMMvf89yQyXne/880kvU0c30=')
ks1.loginResult()

ks2 = THB.LINE() #assist3
ks2.login(token='Eol7BOmxjMi0gY2RiUCc.60B/4m3Vqcm9lowatO1v+a.GzQJuksSlWTQMKMSdLPG9f1Xg35RTxybEVmaRaPfcy4=')
ks2.loginResult()

ks3 = THB.LINE() #assist4
ks3.login(token='EoBPZq4IGNGuOO42I4a3.cVuNKVDQhe/Hx3da0HLj4W.YTQerKMt9iYWmNsSTmsF1mqreQH2nqF4by4u4B/UkLU=')
ks3.loginResult()

ks4 = THB.LINE() #assist5
ks4.login(token='EoKc9ECWmCx2thpGXfs5./cI4oSkuGq2zYiJUH7lUzq.XfCbDOvyoVm7YmR/jnuuzDREX/lwGAlf2Ts++U2f/PY=')
ks4.loginResult()

ks5 = THB.LINE() #assist6
ks5.login(token='EoS9qMNoNQuHTwcBHU0c.D74IYx1ai9/RPhGMo3eTla.ffplSJofsQvD4bEjPIWJudx+NWIk8ZpY78RuYfPZLe0=')
ks5.loginResult()
...
helpmsg ="""
╔═════════════
║ ꧁ⅅ҈ ℰ҈ ℱ҈ ℱ҈ ℰ҈ ℕ҈ ⅅ҈ ℰ҈ ℛ҈ 
║ᝨ҈ ℰ҈ ᗅ҈ ℳ҈  ℬ҈ ᝪ҈ ᝨ҈ Տ҈ ꧂
╠═════════════
║ ̶̴̶̶̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́丂̶̶̴̶̶̴̶̶̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́ᴇ̶̶̴̶̶̴̶̶̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́ʟ̶̶̴̶̶̴̶̶̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́ғ̶̶̴̶̶̴̶̶̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́ʙ̶̶̴̶̶̴̶̶̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́ᴏ̶̶̴̶̶̴̶̶̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́ᴛ̶̶̴̶̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́̈́͊̈́
╠═════════════
║[❂]google (text)
║[❂]playstore (text)
║[❂]instagram (username)
...
Amid = ks.getProfile().mid

Bots=[mid,Amid]
admin=["u5b35770e73cfaed07833c355f6705bd5",mid,Amid]
owner=["u5b35770e73cfaed07833c355f6705bd5","ubd88fa224370766b4a9bf74ed08195b2"]
creator=["u5b35770e73cfaed07833c355f6705bd5","ubd88fa224370766b4a9bf74ed08195b2"]
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"""Thx for add me, Selfbot By : NyX""",
    "lang":"JP",
    "comment":"AUTO LIKED\nSUPPORTED BY : ꧁ⅅ҈ ℰ҈ ℱ҈ ℱ҈ ℰ҈ ℕ҈ ⅅ҈ ℰ҈ ℛ҈  ᝨ҈ ℰ҈ ᗅ҈ ℳ҈  ℬ҈ ᝪ҈ ᝨ҈ Տ҈ ꧂",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["kickMention"] == True:
                     contact = kr.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag Me!! Im Busy, ",cName + " Ngapain Ngetag?, ",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja, ", "-_-, ","NyX lagi off, ", cName + " Kenapa Tag saya?, ","SPAM PC aja, " + cName, "Jangan Suka Tag gua, " + cName, "Kamu siapa, " + cName + "?", "Ada Perlu apa, " + cName + "?","Tag doang tidak perlu., "]
            ...
            if msg.contentType == 13:
                if wait["wblack"] == True:
                    if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        ...
                        ks.sendText(msg.to,"In Blacklist")
                        wait["wblack"] = False
                    else:
                    ...
                    if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        ...
                        ks.sendText(msg.to,"Not in Blacklist")
                ...
                if wait["lang"] == "JP":
                    ...
                    kr.sendText(msg.to,helptranslate)
            elif msg.text in ["Sp","Speed","speed","sp","Hb Speed","Hb speed","Hb Sp","Hb sp"]:
                start = time.time()
                kr.sendText(msg.to, "Wait....")
...
#======================== FOR COMMAND MODE ON STARTING ==========================#
                ...
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        ...
                        ks.sendText(msg.to,"Protecion Already On")
                    else:
                        kr.sendText(msg.to,"Protecion Already On")
                        ks.sendText(msg.to,"Protecion Already On")
                else:
                ...
                if wait["linkprotect"] == True:
                    if wait["lang"] == "JP":
                        ...
                        ks.sendText(msg.to,"Protection Qr already On")
                    else:
                        kr.sendText(msg.to,"Protection Qr already On")
                        ks.sendText(msg.to,"Protection Qr already On")
                else:
                ...
                if wait["inviteprotect"] == True:
                    if wait["lang"] == "JP":
                        ...
                        ks.sendText(msg.to,"Protection Invite already On")
                    else:
                        kr.sendText(msg.to,"Protection Invite already On")
                        ks.sendText(msg.to,"Protection Invite already On")
                else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ks.sendText(msg.to,"ρяσтє¢тισи ιиνιтє ѕєт тσ σи")
                    else:
                        kr.sendText(msg.to,"ρяσтє¢тισи ιиνιтє αℓяєα∂у σи")
                        ks.sendText(msg.to,"ρяσтє¢тισи ιиνιтє αℓяєα∂у σи")
                if wait["cancelprotect"] == True:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"¢αи¢єℓ ρяσтє¢тισи ѕєт тσ σи")
                        ks.sendText(msg.to,"¢αи¢єℓ ρяσтє¢тισи ѕєт тσ σи")
                    else:
                        kr.sendText(msg.to,"¢αи¢єℓ ρяσтє¢тισи αℓяєα∂у σи")
                        ks.sendText(msg.to,"¢αи¢єℓ ρяσтє¢тισи αℓяєα∂у σи")
                else:
...
#======================== FOR COMMAND MODE OFF STARTING ==========================#
                ...
                if wait["protect"] == False:
                    if wait["lang"] == "JP":
                        ...
                        ks.sendText(msg.to,"Protecion already Off")
                    else:
                        kr.sendText(msg.to,"Protection already Off")
                        kr.sendText(msg.to,"Protecion already Off")
                else:
                    wait["protect"] = False
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ρяσтє¢тισи ѕєт тσ σff")
                        ks.sendText(msg.to,"ρяσтє¢тισи ѕєт тσ σff")
                    else:
                        kr.sendText(msg.to,"ρяσтє¢тισи αℓяєα∂у σff")
                        ks.sendText(msg.to,"ρяσтє¢тισи αℓяєα∂у σff")
                if wait["linkprotect"] == False:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"Protection Qr already off")
                        ks.sendText(msg.to,"Protection Qr already Off")
                    else:
                        kr.sendText(msg.to,"Protection Qr already off")
                        ks.sendText(msg.to,"Protection Qr already off")
                else:
                ...
                if wait["inviteprotect"] == False:
                    if wait["lang"] == "JP":
                        ...
                        kr.sendText(msg.to,"Protection Invite already Off")
                        ks.sendText(msg.to,"Protection Invite already Off")
                else:
                ...
                if wait["cancelprotect"] == False:
                    if wait["lang"] == "JP":
                        ...
                        ks.sendText(msg.to,"Protection Cancel already Off")
                    else:
                        ks.sendText(msg.to,"Protection Cancel already Off")
                        kr.sendText(msg.to,"Protection Cancel already Off")
                else:
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        ...
                        ks.sendText(msg.to,"ɕσηϯαɕϯ ςεϯ ϯσ ση")
                    else:
                        kr.sendText(msg.to,"ɕσηϯαɕϯ ςεϯ ϯσ ση")
                        ks.sendText(msg.to,"ɕσηϯαɕϯ ςεϯ ϯσ ση")
                else:
                ...
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        ...
                        ks.sendText(msg.to,"ɕσηϯαɕϯ ςεϯ ϯσ σƒƒ")
                    else:
                        kr.sendText(msg.to,"ɕσηϯαɕϯ αʆɾεαδψ σƒƒ")
                        ks.sendText(msg.to,"ɕσηϯαɕϯ αʆɾεαδψ σƒƒ")
                else:
                    wait["contact"] = False
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"ɕσηϯαɕϯ ςεϯ ϯσ σƒƒ")
                ...
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"Protection Already On")
                        ks.sendText(msg.to,"Protection Already On")
                    else:
                        kr.sendText(msg.to,"Protection Already On")
                        ks.sendText(msg.to,"Protection Already On")
                else:
                ...
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
                        ...
                        ks.sendText(msg.to,"αυтσʝσιи ѕєт тσ σи")
                    else:
                        kr.sendText(msg.to,"αυтσʝσιи αℓяєα∂у σи")
                        ks.sendText(msg.to,"αυтσʝσιи αℓяєα∂у σи")
                else:
                    wait["autoJoin"] = True
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"αυтσʝσιи ѕєт тσ σи")
                ...
                if wait["autoJoin"] == False:
                    if wait["lang"] == "JP":
                        ...
                        ks.sendText(msg.to,"αυтσʝσιи ѕєт тσ σff")
                    else:
                        kr.sendText(msg.to,"αυтσʝσιи αℓяєα∂у σff")
                        ks.sendText(msg.to,"αυтσʝσιи αℓяєα∂у σff")
                else:
                    wait["autoJoin"] = False
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"αυтσʝσιи ѕєт тσ σff")
                ...
                md = """╔═════════════\n"""
                if wait["contact"] == True: md+="╠[❂]Contact:on [(A OK)]\n"
                else: md+="╠[❂]Contact:off [(No No No)]\n"
                if wait["autoJoin"] == True: md+="╠[❂]Auto Join:on [(A OK)]\n"
                else: md +="╠[❂]Auto Join:off [(No No No)]\n"
                if wait["autoCancel"]["on"] == True:md+="╠[❂]Auto cancel:" + str(wait["autoCancel"]["members"]) + "[✅]\n"
                else: md+= "╠[❂]Group cancel:off [(No No No)]\n"
                if wait["leaveRoom"] == True: md+="╠[❂]Auto leave:on [(A OK)]\n"
                else: md+="╠[❂]Auto leave:off [(No No No)]\n"
                if wait["timeline"] == True: md+="╠[❂]Share:on [(A OK)]\n"
                else:md+="╠[❂]Share:off [(No No No)]\n"
                if wait["autoAdd"] == True: md+="╠[❂]Auto add:on [(A OK)]\n"
                else:md+="╠[❂]Auto add:off [(No No No)]\n"
                if wait["protect"] == True: md+="╠[❂]Protect:on [(A OK)]\n"
                else:md+="╠[❂]Protect:off [(No No No)]\n"
                if wait["linkprotect"] == True: md+="╠[❂]Link Protect:on [(A OK)]\n"
                else:md+="╠[❂]Link Protect:off [(No No No)]\n"
                if wait["inviteprotect"] == True: md+="╠[❂]Invitation Protect:on [(A OK)]\n"
                else:md+="╠[❂]Invitation Protect:off [(No No No)]\n"
                if wait["cancelprotect"] == True: md+="╠[❂]Cancel Protect:on [(A OK)]\n"
                else:md+="╠[❂]Cancel Protect:off [(No No No)]\n╚═════════════"
                kr.sendText(msg.to,md)
            elif cms(msg.text,["creator","Creator","Hb Creator","Hb creator"]):
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u5b35770e73cfaed07833c355f6705bd5"}
                kr.sendMessage(msg)
                kr.sendText(msg.to,'Itu adalah creator bodoh saya 😂  􀜁􀄯􏿿')
...
#==============================================================================#
            ...
            elif msg.text in ["Like:on","Like on","like on","like:on","Hb Like on","Hb Like On","Hb like:on"," Hb Like:on"]:
                if wait["likeOn"] == True:
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"Done")
                else:
            ...
            elif msg.text in ["Like off","Like:off","like off","like:off","Hb Like off"," Hb Like Off","Hb like off","Hb Like:off","Hb like:off"]:
            ...
            elif msg.text in ["Simisimi on","Simisimi:on","Hb Simisimi on","Hb simisimi on"]:
                settings["simiSimi"][msg.to] = True
                kr.sendText(msg.to,"Simi mode On")
                
            elif msg.text in ["Simisimi off","Simisimi:off","Hb Simisimi off","Hb simisimi off","Hb Simisimi:off","Hb simisimi:off"]:
                settings["simiSimi"][msg.to] = False
                kr.sendText(msg.to,"Simi mode Off")
                
            elif msg.text in ["Autoread on","Read:on","autoread on","read on","Hb Autoread on","Hb autoread on","Hb Read on","Hb read on"]:
                wait['alwayRead'] = True
            ...
            elif msg.text in ["Respontag on","Autorespon:on","Respon on","Respon:on","Hb respon on","Hb Respon on","Hb Autorespon on","Hb autorespon on","Hb respon:on","Hb Respon:on"]:
                wait["detectMention"] = True
                kr.sendText(msg.to,"Auto respon tag On")
                
            elif msg.text in ["Respontag off","Autorespon:off","Respon off","Respon:off","respontag off","autorespon off","respon off","respon:off","autorespon:off"]:
                wait["detectMention"] = False
                kr.sendText(msg.to,"Auto respon tag Off")
            
            elif msg.text in ["Kicktag on","Autokick:on","Responkick on","Responkick:on","kicktag on","autokick:on","responkick on","responkick:on"]:
...
#==============================================================================#
            elif msg.text in ["Sambut on","sambut on","Hb Sambut on","Hb sambut on","Sambut:on","sambut:on","Hb Sambut:on","Hb sambut:on"]:
                if wait["Wc"] == True:
                    if wait["lang"] == "JP":
            ...
            elif msg.text in ["Sambut off","sambut off","Hb Sambut off","Hb sambut off","Sambut:off","sambut:off","Hb Sambut:off","Hb sambut:off"]:
                if wait["Wc"] == False:
                    if wait["lang"] == "JP":
...
#==============================================================================#
            elif msg.text in ["Pergi on","pergi on","Pergi:on","pergi:on"]:
                if wait["Lv"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"already on")
            elif msg.text in ["Pergi off","pergi off","Pergi:off","pergi:off"]:
                if wait["Lv"] == False:
                    if wait["lang"] == "JP":
...
#==============================================================================#
				...
				if msg.toType == 2:
					if msg.toType == 2:
						...
						gs = ks1.getGroup(msg.to)
						gs = ks2.getGroup(msg.to)
						gs = ks3.getGroup(msg.to)
						gs = ks4.getGroup(msg.to)
						gs = ks5.getGroup(msg.to)
						...
						if targets == []:
							...
							for target in targets:
								try:
									klist=[kr,ks,ks1,ks2,ks3,ks4,ks5]
              ...
              if msg.from_ in owner:
                ...
                if msg.toType == 2:
                   ...
                   for target in targets:
                       try:
                           ks1.kickoutFromGroup(msg.to,[target])
                           ks1.inviteIntoGroup(msg.to,[target])
                           ks1.cancelGroupInvitation(msg.to,[target])
                       except:
                           kr.sendText(msg.to,"Error")
...
#==============================================================================#
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
            elif "bye all" in msg.text:
                if msg.toType == 2:
                    ginfo = kr.getGroup(msg.to)
                    try:
                        kr.leaveGroup(msg.to)
                        ks.leaveGroup(msg.to)
                        ks1.leaveGroup(msg.to)
                        ks2.leaveGroup(msg.to)
                        ks3.leaveGroup(msg.to)
                        ks4.leaveGroup(msg.to)
                        ks5.leaveGroup(msg.to)
                    except:
                        pass
            elif msg.text in ["Exorcist","Join all","join all","Join All","join All","Kuy","Hb Join","Hb join","Hb Join all","Hb join all","Hb in","Hb In"]: #Panggil Semua Bot
              if msg.from_ in admin:
                ...
                time.sleep(0.01)
                ks1.acceptGroupInvitationByTicket(msg.to,Ticket)
                time.sleep(0.01)
                ks2.acceptGroupInvitationByTicket(msg.to,Ticket)
                time.sleep(0.01)
                ks3.acceptGroupInvitationByTicket(msg.to,Ticket)
                time.sleep(0.01)
                ks4.acceptGroupInvitationByTicket(msg.to,Ticket)
                time.sleep(0.01)
                ks5.acceptGroupInvitationByTicket(msg.to,Ticket)
                time.sleep(0.01)
                G = cl.getGroup(msg.to)
                ginfo = cl.getGroup(msg.to)
                G.preventJoinByTicket = True
...
#-------------Fungsi Tagall User Start---------------#
            elif msg.text in ["Tag all","Tagall"," tag all","Hb tagall","Hb Tagall","Hb Tag All","Hb TagAll","Tag","tag"]:
              if msg.from_ in admin:
                group = kr.getGroup(msg.to)
    ...
    #-------------Fungsi Tagall User  Edit By NyX-------------#
            ...
            elif msg.text in ["toong","Toong","Read","read"]:
                 if msg.toType == 2:
                    print "\nRead aktif..."
                    if msg.to in wait2['readPoint']:
...
#==============================================================================#
                ...
                if len(string.decode('utf-8')) <= 10000000000:
                    ...
                    ks.sendText(msg.to,"Changed " + string + "")
            elif "Bot2 rename: " in msg.text:
                string = msg.text.replace("Bot2 rename;: ","")
                if len(string.decode('utf-8')) <= 10000000000:
                    profile = ks1.getProfile()
                    profile.displayName = string
                    ks1.updateProfile(profile)
                    ks1.sendText(msg.to,"Changed " + string + "")
                ...
                if len(string.decode('utf-8')) <= 10000000000:
                    ...
                    ks2.sendText(msg.to,"Changed " + string + "")
            elif "Bot4 rename: " in msg.text:
                string = msg.text.replace("Bot4 rename: ","")
                if len(string.decode('utf-8')) <= 10000000000:
                    profile = ks3.getProfile()
                    profile.displayName = string
                    ks3.updateProfile(profile)
                    ks3.sendText(msg.to,"Changed " + string + "")
            elif "Bot5 rename: " in msg.text:
                string = msg.text.replace("Bot5 rename: ","")
                if len(string.decode('utf-8')) <= 10000000000:
                    profile = ks4.getProfile()
                    profile.displayName = string
                    ks4.updateProfile(profile)
                    ks4.sendText(msg.to,"Changed " + string + "")
            elif "Bot6 rename: " in msg.text:
                string = msg.text.replace("Bot6 rename: ","")
                if len(string.decode('utf-8')) <= 10000000000:
                    profile = ks5.getProfile()
                    profile.displayName = string
                    ks5.updateProfile(profile)
                    ks5.sendText(msg.to,"Changed " + string + "")
              ...
              if msg.from_ in admin:
                ...
                try:
                    ...
                    kr.sendText(msg.to, pesan)
                        ...
                        try:
                            pesan="Teks nya kepanjangan! Kunjungi link dibawah aja\n"
                            pesan+=wikipedia.page(wiki).url
                            kr.sendText(msg.to, pesan)
                        except Exception as e:
                            kr.sendText(msg.to, str(e))    
...
#=================================KRIS SCRIPT FINISHED =============================================#
            ...
            elif msg.text in ["Clear","clear","Clear ban","Clear Ban","Clearban","clearban"]:
                wait["blacklist"] = {}
                kr.sendText(msg.to,"Blacklist Telah Dibersihkan")
            elif msg.text in ["Ban:on","ban:on","Ban","ban"]:
                wait["wblacklist"] = True
                kr.sendText(msg.to,"Send Contact")
            elif msg.text in ["Unban:on","unban:on","Ban","ban"]:
                wait["dblacklist"] = True
                kr.sendText(msg.to,"Send Contact")
            elif msg.text in ["Banlist","banlist","Blist","blist"]:   
                if wait["blacklist"] == {}:
                    ...
                    kr.sendText(msg.to, msgs)
            elif msg.text in ["Conban","Contactban","Contact ban","conban","contactban","contact ban"]:
                if wait["blacklist"] == {}:
                    kr.sendText(msg.to,"Tidak Ada Blacklist")
                else:
                    ...
                    for i in wait["blacklist"]:
                        ...
                        kr.sendMessage(M)
            elif msg.text in ["Midban","Mid ban","midban","mid ban"]:
                if msg.toType == 2:
                    group = kr.getGroup(msg.to)
    ...
    for zx in range(0,20):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          kr.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"✍Ŧ€₳M ж Ħ₳ʗҜ฿❂Ŧ✈")
          print "Like"
        except:
          pass
      else:
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in mid:
                try:
                    ...
                    kr.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AUTOLIKE BY : \n✍Ŧ€₳M ж Ħ₳ʗҜ฿❂Ŧ✈")
                    print "Like"
                except:
                    pass
            else:
